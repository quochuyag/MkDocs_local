...
source: The-Oracle-Database-Performance-Tuning-Course/labs/SO_TAY_MO_HINH.md
---
...
> 🎨 **Bản tương tác sinh động hơn (mở bằng trình duyệt):** [SO_TAY_MO_HINH.html](so-tay-mo-hinh.html) — cây quyết định bấm từng bước, sơ đồ màu, quiz ẩn/hiện đáp án.
...
!!! info "Nguồn gốc"
    `The-Oracle-Database-Performance-Tuning-Course/labs/SO_TAY_MO_HINH.md`
