...
source: The-Oracle-Database-Performance-Tuning-Course/oracle_dba_system_prompt.md
---
...
!!! info "Nguồn gốc"
    `The-Oracle-Database-Performance-Tuning-Course/oracle_dba_system_prompt.md`
